...
export default async function CreatorDashboard({ searchParams }: { searchParams: Promise<{ uploaded?: string; deleted?: string }> }) {
  ...
  return <><Header/><main><section className="page-title"><span className="badge">CREATOR</span><h1>Olá, {profile.displayName}</h1><p>@{profile.username}</p></section>
    ...
    {params.deleted ? <div className="success-banner">Publicação e ficheiro eliminados.</div> : null}
